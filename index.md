...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<h1 title="Class CountComment" class="title">Class CountComment</h1>
</div>
<div class="inheritance" title="Inheritance Tree">java.lang.Object
<div class="inheritance">CountComment</div>
</div>
<section class="description">
<hr>
<pre>public class <span class="type-name-label">CountComment</span>
extends java.lang.Object</pre>
...
<tbody>
<tr class="alt-color">
<th class="col-constructor-name" scope="row"><code><span class="member-name-link"><a href="#%3Cinit%3E()">CountComment</a></span>()</code></th>
<td class="col-last">&nbsp;</td>
</tr>
</tbody>
</table>
...
<tr class="row-color" id="i1">
<td class="col-first"><code>static void</code></td>
<th class="col-second" scope="row"><code><span class="member-name-link"><a href="#NumberOfComment()">NumberOfComment</a></span>()</code></th>
<td class="col-last">
<div class="block">This method will read students' comments from https://github.com/STIW3054-A201/Main-Data/issues/4
 It extracts the user ID of the students and the number that they comment
 It compare and count the number of who comment more than one
 It display number of submission and number of students made more than one submission
 It does not return any value because it display the result</div>
</td>
</tr>
</tbody>
</table>
...
<section class="detail" id="&lt;init&gt;()">
<h3>CountComment</h3>
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="member-name">CountComment</span>()</div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="NumberOfComment()">
<h3>NumberOfComment</h3>
<div class="member-signature"><span class="modifiers">public static</span>&nbsp;<span class="return-type">void</span>&nbsp;<span class="member-name">NumberOfComment</span>()
                            throws <span class="exceptions">java.io.IOException</span></div>
<div class="block">This method will read students' comments from https://github.com/STIW3054-A201/Main-Data/issues/4
 It extracts the user ID of the students and the number that they comment
 It compare and count the number of who comment more than one
